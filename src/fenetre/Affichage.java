...
public class Affichage {
	...
	public void AfficherCarte(Player joueur, Carte carte){
		this.print(joueur.getName() + " tire une carte " 
				+ carte.getPaquet().getName() + "\n"
				+ carte.toString() + "\n");
	}
	...
	public void CompagnieCarte(Player joueur, Player possesseur, int somme){
		this.print(joueur.getName() + " tombe sur la case de "
				+ possesseur.getName() + " et doit payer "
				+ somme + "$.\n");
	}
